...
if st.button("Calculate trip time"):
    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='1000' height='1200'>
      ...
      <line x1='100' y1='100' x2='900' y2='100' stroke='green' stroke-width='20'/>
    """
    ...
    def draw_stop(name, x, highlight=False):
        ...
        return f"""
            <circle cx='{x}' cy='100' r='44' fill='{fill}' stroke='{stroke}' stroke-width='8'/>
            <text x='{x}' y='245' font-size='24' text-anchor='middle'>{name}</text>
        """
